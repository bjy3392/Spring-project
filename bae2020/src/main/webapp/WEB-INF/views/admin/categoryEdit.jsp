                  	...
                  	<div id="content_input">
                    	<table>
                            ...
                            <c:forEach var="vo" items="${vos }" varStatus="status">
	                            <tr>
	                                <td><input type="text" id="first_code_${status.count}" value="${vo.first_code }" disabled></td>
	                                <td><input type="text" id="category_name_${status.count}" value="${vo.category_name }" disabled></td>
	                                <td>
                            ...
                            <tr>
                            	<td><input type="text" id="first_code"></td>
